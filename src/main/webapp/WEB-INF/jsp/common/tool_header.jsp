...
<link href="<%=request.getContextPath()%>/resources/css/tools.css" rel="stylesheet">
...
<script src="<%=request.getContextPath()%>/resources/js/bootstrap/jquery.bootpag.js"></script>
